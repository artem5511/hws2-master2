...
// constants
const defaultAffairs: AffairType[] = [ // need
...
function HW2() {
    const [affairs, setAffairs] = useState<AffairType[]>(defaultAffairs) // need
    const [filter, setFilter] = useState<FilterType>('all')

    const filteredAffairs = filterAffairs(affairs, filter)
    const deleteAffairCallback = (_id: number) => { // need
        setAffairs(deleteAffair(affairs,_id))// need
    }
